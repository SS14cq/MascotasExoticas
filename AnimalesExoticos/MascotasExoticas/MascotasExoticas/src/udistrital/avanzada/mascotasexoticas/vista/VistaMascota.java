 ...
 *     12-10-2025
 */
public class VistaMascota extends JFrame implements IRegistroVista{
    ...
    private void inicializarPanelBotones() {
        ...
        btnSeleccionarArchivo = new JButton("Cargar archivo .properties");
        ...
        estilizarBoton(btnSeleccionarArchivo, new Color(220, 20, 60));
    ...
    /**
     * Abre un diálogo para seleccionar un archivo de destino para serializar mascotas.
     * 
     * <p>Este método encapsula el uso de {@link JFileChooser} dentro de la vista,
     * de manera que los controladores no dependan de componentes gráficos.
     * </p>
     * 
     * @param nombreSugerido Nombre de archivo sugerido por defecto (por ejemplo, "mascotas_idpyba.ser").
     * @return Archivo seleccionado por el usuario, o {@code null} si se canceló la operación.
     */
    public File seleccionarArchivoParaSerializar(String nombreSugerido) {
...
/**
     * Muestra un diálogo para completar los campos faltantes de una mascota.
     *
     * @param nombre Nombre actual o vacío.
     * @param apodo Apodo actual o vacío.
     * @param clasificacion Clasificación actual o vacía.
     * @param familia Familia actual o vacía.
     * @param genero Género actual o vacío.
     * @param especie Especie actual o vacía.
     * @param alimento Tipo de alimento actual o vacío.
     * @return Un arreglo con los datos completos o {@code null} si el usuario cancela.
     */
    @Override
    public String[] completarRegistroIncompleto(String nombre, String apodo, String clasificacion,
                                                String familia, String genero, String especie, String alimento) {
        RegistroDialog dialog = new RegistroDialog(this, nombre, apodo, clasificacion, familia, genero, especie, alimento);
     ...
     * un archivo de propiedades (.properties).
     * 
     * @return El archivo seleccionado o {@code null} si se cancela la operación.
     */
    public File seleccionarArchivoProperties() {
        JFileChooser chooser = new JFileChooser();
        chooser.setDialogTitle("Seleccionar archivo de propiedades de mascotas");
